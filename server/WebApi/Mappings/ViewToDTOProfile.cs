...
namespace MoneyManager.WebApi.Mappings
{
    public class ViewToDTOProfile : Profile
    {
        public ViewToDTOProfile()
        {
            ...
            CreateMap<CurrencyTransactionModel, CurrencyTransactionDto>().ReverseMap();
            ...
            CreateMap<BanksGlobalDashboardDto, BanksGlobalDashboardModel>().ReverseMap();
            ...
            CreateMap<BrokerAccountDayTransferDto, BrokerAccountDayTransferModel>().ReverseMap();
