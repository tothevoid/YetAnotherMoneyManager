        ...
        <CardBody>
            <Flex justifyContent="space-between" alignItems="center">
                ...
                <Flex gap={2} justifyContent="space-between" alignItems="center">
                    ...
                    <Button background={'background_secondary'} size={'sm'} onClick={props.onEditCallback}>
                        <Icon color="card_action_icon_primary">
                            <MdEdit/>
                        </Icon>
                    </Button>
                    <Button background={'background_secondary'} size={'sm'} onClick={props.onDeleteCallback}>
